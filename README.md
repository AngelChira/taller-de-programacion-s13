#   Semana 13 Taller de Programación 
Este repositorio es sobre la tarea de la semana 13 del curso de taller de programación
...
```
https://github.com/AngelChira/taller-de-programacion-s13
```

2. Abrir el Apache NetBeans y seleccionar "Open Project" en la parte superior izquierda
3. Navega hasta la ubicación del proyecto "semana13" y haz 2 click en el proyecto.
